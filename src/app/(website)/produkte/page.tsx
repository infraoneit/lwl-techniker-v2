          ...
          {kategorien.map((k) => (
            <div key={k.titel}>
              ...
              <ul className="mt-5 divide-y divide-linie border-y border-linie">
                {k.eintraege.map((p) => (
                  <li key={p.slug} className="flex flex-wrap items-center justify-between gap-x-6 gap-y-2 py-4">
                    <div>
                    ...
                    {p.dokument ? (
                      <a
                        ...
                        className="inline-flex shrink-0 items-center gap-2 text-sm font-semibold text-marke hover:text-marke-hell"
                      >
